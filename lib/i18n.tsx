...
const dict = {
  ...
  duprRS: { zh: '可靠度分數', en: 'Reliability Score' },
  duprFilterTitle: { zh: 'DUPR 查詢篩選', en: 'DUPR Filter' },
  duprFilterConfirm: { zh: '開始查詢', en: 'Search' },
  duprGender: { zh: '性別', en: 'Gender' },
  genderAll: { zh: '任何人', en: 'All' },
  genderMale: { zh: '男性', en: 'Male' },
  genderFemale: { zh: '女性', en: 'Female' },
  duprType: { zh: '類型', en: 'Type' },
  duprDoubles: { zh: '雙打', en: 'Doubles' },
  duprSingles: { zh: '單打', en: 'Singles' },
  duprRatingRange: { zh: 'DUPR 級別', en: 'DUPR Rating' },
  duprAgeRange: { zh: '年齡範圍', en: 'Age Range' },
  ageUnder19: { zh: '19以下', en: '≤19' },
